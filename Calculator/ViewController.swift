...
//  Calculator
//
//  Created by Field Employee on 11/28/20.
//
...
class ViewController: UIViewController {
    ...
    enum Sign{
        case positive,negative,clear,percent
    }
    ...
    private func setupNumberPad(){
        ...
        resultLabel.frame = CGRect(x: 20,y: holder.frame.size.height-(buttonSize*5) - 100,width: view.frame.size.width-40,height: 100)
    ...
    @objc func operationPressed(_ sender: UIButton){
        ...
        else if tag == 2 {currentOperations = .add}
        else if tag == 3 {currentOperations = .subtract}
        else if tag == 4 {currentOperations = .multiply}
        else if tag == 5 {currentOperations = .divide}
